...
def main():
	...
	master_rtable(r_2012, r_2011, r_2010, r_2009, savename)
...
def spring_wk(year, column_1, column_2, column_3):
    ...
    # dropping the rows where naN's are present in dataset_2
...
def master_rtable(r_1, r_2, r_3, r_4, savename):
    ...
    r_c.to_csv('../results/computational_experiments/'+savename+'.csv')
