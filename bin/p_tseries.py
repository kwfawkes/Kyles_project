...
def main():
	...
	combination_data = spring_wk(year, gwv_data, zoo, gwv_data.sig_wave_height, gwv_data.sea_surface_temperature, zoo.Total_Zooplankton_Abundance)

	timeseries(combination_data, combination_data.sig_wave_height, combination_data.sea_surface_temperature, combination_data.Total_Zooplankton_Abundance, savename)
